            ...
            definitions: [
                {
                    ...
                    desc: `
                        ...
                        <br>
                        ※ <b>필수 문장성분</b>: <span class="s">주어(S)</span>, <span class="v">동사(V)</span>, <span class="o">목적어(O)</span>, <span class="c">보어(C)</span><br>
                        ※ <span class="m">수식어(M)</span>는 문장의 형식을 결정짓지 않는 <b>부가 성분</b>입니다.
                    `,
                    example: "",
                    ex_meaning: ""
                }
            ...
            definitions: [
                {
                    ...
                    desc: "핵심: <b>자동사</b> (목적어 필요 없음). 문장이 길다면 <span class='m'>수식어(M)</span> 때문입니다.<br>주요 동사: go, come, arrive, rise, fall, work, happen, disappear",
            ...
            definitions: [
                {
                    ...
                    desc: "핵심: <b>타동사</b>. 대상이 되는 <span class='o'>목적어(O)</span>가 반드시 필요.<br>주요 동사: make, study, discuss, reach, attend, want, hope",
    ...
    parts: [
            ...
            definitions: [
                {
                    ...
                    desc: "기능: <span class='s'>주어(S)</span>, <span class='o'>목적어(O)</span>, <span class='c'>보어(C)</span> 자리에 들어갑니다.",
            ...
            definitions: [
                {
                    ...
                    desc: "기능: 문장의 <span class='v'>동사(V)</span> 자리에 들어갑니다.",
        ...
        },
        {
            ...
            definitions: [
                {
                    pos: "adj.",
                    meaning: "명사의 성질, 상태, 크기, 색깔 등을 설명하는 말입니다.",
                    desc: "기능: <b>명사(Noun)</b>를 수식하거나, <span class='c'>보어(C)</span> 자리에 들어갑니다.",
        ...
        },
        {
            ...
            definitions: [
                {
                    pos: "adv.",
                    meaning: "명사를 제외한 나머지(동사, 형용사, 다른 부사 등)를 꾸며줍니다.",
                    desc: "기능: <span class='m'>수식어(M)</span> 역할만 합니다. 문장 구조에는 포함되지 않습니다.",
            ...
            definitions: [
                {
                    ...
                    desc: "기능: 뒤에 명사와 함께 <span class='m'>수식어(M)</span> 덩어리를 만듭니다.",
        ...
        },
        {
            ...
            definitions: [
                {
                    pos: "conj.",
                    meaning: "단어와 단어, 문장과 문장을 연결해 주는 말입니다.",
            ...
            definitions: [
                {
                    ...
                    desc: "기능: <span class='s'>주어</span>, <span class='o'>목적어</span>, <span class='c'>보어</span> 자리에 위치",
                ...
                },
                {
                    ...
                    desc: "기능: <span class='v'>동사</span> 수식, <span class='m'>수식어(M)</span> 역할",
                    example: "<span class='s'>I</span> <span class='v'>went</span> <span class='m'>there to meet him</span>.",
                    ex_meaning: "<span class='s'>나는</span> <span class='m'>그를 만나기 위해 거기에 갔다</span>."
                }
            ]
        },
        {
